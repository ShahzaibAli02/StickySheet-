...
public abstract class FrameProcessorBase<T> implements FrameProcessor {
      ...
      detectInImage(image)
          .addOnSuccessListener(
              results -> {
                ...
                FrameProcessorBase.this.onSuccess(image, results, graphicOverlay,processingFrameMetaData.rotation);
                processLatestFrame(graphicOverlay);
              })
  ...
  protected abstract void onSuccess(
          FirebaseVisionImage image, T results, GraphicOverlay graphicOverlay, int rotation);
